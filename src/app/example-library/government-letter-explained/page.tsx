...
export const metadata: Metadata = {
  title: "Government Letter Explained: Official Notice, Deadline & Next Steps | Klarium",
  description: "Understand a government letter or official notice in plain language. Learn what it means, what action is required, how to find the deadline, and what to verify safely.",
...
const STRUCTURED_DATA = {
  ...
  "@type": "Article",
  headline: "Government Letter Explained: Official Notice, Deadline & Next Steps",
  description: "A practical guide to understanding a government letter or official notice, including deadlines, requested documents, next steps, and safe verification.",
  url: "https://www.klarium.co/example-library/government-letter-explained",
  publisher: { "@type": "Organization", name: "Klarium", url: "https://www.klarium.co" },
};
...
const BREADCRUMB_DATA = {
  ...
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Klarium", item: "https://www.klarium.co" },
    { "@type": "ListItem", position: 2, name: "Example Library", item: "https://www.klarium.co/example-library" },
    { "@type": "ListItem", position: 3, name: "Government Letter Explained", item: "https://www.klarium.co/example-library/government-letter-explained" },
  ],
};
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F5F5F7", fontFamily: "Inter,system-ui,-apple-system,sans-serif", color: "#1D1D1F", WebkitFontSmoothing: "antialiased" }}>
      ...
      <main style={{ maxWidth: 780, margin: "0 auto", padding: "40px 20px 80px" }}>
        <nav aria-label="Breadcrumb" style={{ fontSize: 12, color: "#6E6E73", marginBottom: 20 }}><Link href="/" style={{ color: "#0066CC" }}>Klarium</Link>{" / "}<Link href="/example-library" style={{ color: "#0066CC" }}>Example Library</Link>{" / "}<span>Government Letter Explained</span></nav>
        <header style={{ marginBottom: 28 }}><p style={{ fontSize: 11, fontWeight: 700, color: "#0066CC", letterSpacing: ".08em", textTransform: "uppercase", marginBottom: 10 }}>Official government notice guide</p><h1 style={{ fontSize: "clamp(27px,5vw,42px)", fontWeight: 800, lineHeight: 1.08, letterSpacing: "-.035em", marginBottom: 14 }}>Government Letter Explained: What It Means & What to Do Next</h1><p style={{ maxWidth: 700, fontSize: 17, color: "#5F6368", lineHeight: 1.65 }}>Understand common parts of a government letter or official notice: why you received it, what action is requested, how to find the deadline, and what to verify before responding.</p></header>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: 20 }}><Link href="/guides" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 13px", borderRadius: 9, background: "#fff", border: "1px solid #E5E7EB", color: "#1D4ED8", fontSize: 13, fontWeight: 650 }}>Document Guides <ArrowRight size={13} /></Link><Link href="/legal-document-explainer" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 13px", borderRadius: 9, background: "#fff", border: "1px solid #E5E7EB", color: "#1D4ED8", fontSize: 13, fontWeight: 650 }}>Legal Document Explainer <ArrowRight size={13} /></Link><Link href="/visa-rejection-letter-explained" style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 13px", borderRadius: 9, background: "#fff", border: "1px solid #E5E7EB", color: "#1D4ED8", fontSize: 13, fontWeight: 650 }}>Visa Rejection Letter <ArrowRight size={13} /></Link></div>
