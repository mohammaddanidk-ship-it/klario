...
export const metadata: Metadata = {
  title: "MRI Report Explained in Plain Language | Klarium Example",
  description: "See a real example of an MRI report explained simply — understand radiology terms without the jargon.",
  alternates: { canonical: "/example-library/mri-report-explained" },
};

const BLOCKS = [
  { h: "What this document is", t: "This is the findings section of an MRI report, most likely of the lower spine." },
  { h: "What it says in plain words", t: "There's a mild bulge in one of the discs in your lower back, but it's not pressing on any nerves significantly. There's no fracture or cancer found. The changes seen are common wear-and-tear for your age." },
  { h: "Key things to be aware of", t: "The word 'mild' and 'no significant compression' are reassuring — this is a common, usually manageable finding, not an emergency." },
  { h: "What should I do next", t: "Discuss this report with your doctor to understand if physical therapy or lifestyle changes are recommended. Ask specifically whether any follow-up imaging is needed." }
];
    ...
    <div style={{ minHeight: "100vh", background: "#F5F5F7", fontFamily: "Inter,system-ui,-apple-system,sans-serif", color: "#1D1D1F", WebkitFontSmoothing: "antialiased" }}>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <div style={{ padding: "14px 18px", background: "#fff", border: "1px solid #E5E7EB", borderRadius: 10, marginBottom: 16 }}>
          <p style={{ fontSize: 10, fontWeight: 700, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: ".08em", marginBottom: 8 }}>Sample MRI Report (anonymized example)</p>
          <p style={{ fontSize: 13, color: "#374151", lineHeight: 1.7, fontStyle: "italic", whiteSpace: "pre-line" }}>Findings: Mild disc bulge at L4-L5 with no significant nerve root compression. No evidence of fracture or malignancy. Mild degenerative changes consistent with age.</p>
        </div>
