...
export const metadata: Metadata = {
  title: "Fake Delivery Scam Example — How to Spot It | Klarium",
  description: "See a real example of a fake delivery scam message, broken down red flag by red flag.",
  alternates: { canonical: "/example-library/fake-delivery-scam-example" },
};

const BLOCKS = [
  { h: "Verdict", t: "SCAM — High confidence" },
  { h: "What this message claims to be", t: "A delivery notice requiring a small customs fee payment." },
  { h: "Red flags identified", t: "Legitimate couriers don't collect customs fees via random links — they bill through official channels or on delivery. Very short urgency window (12 hours). Non-official domain name." },
  { h: "What should I do next", t: "Never pay fees through links in unsolicited delivery texts. If you're expecting a package, check tracking only through the courier's official app or website." }
];
    ...
    <div style={{ minHeight: "100vh", background: "#F5F5F7", fontFamily: "Inter,system-ui,-apple-system,sans-serif", color: "#1D1D1F", WebkitFontSmoothing: "antialiased" }}>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <h1 style={{ fontSize: "clamp(26px,5vw,38px)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-.03em", marginBottom: 20 }}>
          Fake Delivery Scam, Broken Down
        </h1>

        <div style={{ padding: "14px 18px", background: "#fff", border: "1px solid #E5E7EB", borderRadius: 10, marginBottom: 16 }}>
          <p style={{ fontSize: 10, fontWeight: 700, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: ".08em", marginBottom: 8 }}>Sample Delivery Scam Message (constructed example)</p>
          <p style={{ fontSize: 13, color: "#374151", lineHeight: 1.7, fontStyle: "italic", whiteSpace: "pre-line" }}>Your package could not be delivered due to unpaid customs fee of $3.50. Pay now to reschedule delivery: track-parcel-fee.com/pay Failure to pay within 12 hours will result in return to sender.</p>
        </div>
