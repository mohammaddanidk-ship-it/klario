...
export const metadata: Metadata = {
  title: "Legal Document Explainer AI — Free & Instant | Klario",
...
export default function Page() {
  return (
    <SEOLanding
      ...
      subtitle="Contracts, tenancy agreements, and legal notices are written in dense legal language designed for lawyers, not everyday people. Klario translates the legal jargon into plain language you can actually use."
      icon={Scale}
      ...
      faqs={[
        { q: "Is Klario a substitute for a lawyer?", a: "No. Klario helps you understand the basics of a document so you know what questions to ask a qualified lawyer for anything important or high-stakes." },
